...
const HomeFoodCard = ({ id, name, image }) => {
    return (
        <div className="flex-col items-center bg-white  hover:scale-105 duration-300 rounded-lg md:w-60">
            <div>
                <img src={image} alt="" className='h-36 w-full rounded-t-xl object-cover' />
            </div>
